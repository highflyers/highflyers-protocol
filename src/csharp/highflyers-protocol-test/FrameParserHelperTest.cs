...
namespace HighFlyers.Test.Protocol
{
	...
	public class FrameParserHelperTest
	{
		...
		public void ShouldReorderBytes ()
		{
			...
			FrameParserHelper.EndianType type = BitConverter.IsLittleEndian ? FrameParserHelper.EndianType.Big
		...
		public void ShouldNotReorderBytes ()
		{
			...
			FrameParserHelper.EndianType type = BitConverter.IsLittleEndian ? FrameParserHelper.EndianType.Little
